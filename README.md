...
Se questi secret mancano, gli step relativi vengono saltati oppure falliscono in modo esplicito e controllato.
...
- `CI`  
  Pipeline principale di continuous integration.

- `Deploy`  
  Pipeline di deploy production via Vercel CLI.
...
- `CodeQL`  
  Analisi di sicurezza CodeQL di GitHub.
